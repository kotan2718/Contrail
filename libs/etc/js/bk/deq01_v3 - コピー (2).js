        ...
        function changeType() {
            ...
            switch (type) {
                ...
                case "10":  // Chua_14_4
                    ...
                    // 初期値デフォルト値
                    document.getElementById('init1_x').value = -0.000001;
                    document.getElementById('init1_y').value = 0;
                    document.getElementById('init1_z').value = 0;
                    document.getElementById('init2_x').value = -0.0000011;
                    document.getElementById('init2_y').value = 0;
                    document.getElementById('init2_z').value = 0;
                    // 式を表示する
                    document.getElementById('dx').innerText = "\\[ \\dot{x} = a(y - x - f(x) where f(x) = cx + 0.5(d - c)(|x + 1| - |x - 1|) \\]";

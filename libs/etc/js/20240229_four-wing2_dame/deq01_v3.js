        ...
        function changeType() {
            ...
            switch (type) {
                ...
                case "06":  // Sprott
                    ...
                    document.getElementById('init2_z').value = -0.541;
                    // 式を表示する
                ...
                case "07":  // Rabinovich-Fabrikant
                    ...
                    document.getElementById('init2_z').value = 0.60001;
                    // 式を表示する
                ...
                case "12":  // Langford
                    ...
                    break;
                case "13":  // Four-Wing 2
                    // https://www.sciencedirect.com/science/article/abs/pii/S0960077907000239
                    dat = 13;
                    changeProperty(0);
                    // vertical axis
                    vAx = 3;
                    ...
                    document.getElementById('width0').value = width0;
                    // 係数デフォルト値
                    document.getElementById('ma').value = 14;
                    document.getElementById('mb').value = 43;
                    document.getElementById('mc').value = -7.2;
                    document.getElementById('md').value = 16;
                    ...
                    me_used = 1;
                    // 初期値デフォルト値
                    document.getElementById('init1_x').value = 39.2;
                    document.getElementById('init1_y').value = -14.3;
                    document.getElementById('init1_z').value = -13.1;
                    document.getElementById('init2_x').value = -39.2;
                    document.getElementById('init2_y').value = 14.3;
                    document.getElementById('init2_z').value = -13.1;
                    // 式を表示する
                    document.getElementById('dx').innerText = "$ \\dot{x} = a(y - x) + eyz $";
                    document.getElementById('dy').innerText = "$ \\dot{y} = cx + dy - xz $";
                    document.getElementById('dz').innerText = "$ \\dot{z} = -bz + xy $";
                    updateRange();
                    document.getElementById('cnt_dp').value = 3200;
                    document.getElementById('dh').value = 0.01;
                    document.getElementById('ma').disabled = false;

...
// scaling
document.getElementById('m_magX').value = (m_xw / (m_xMax - m_xMin)).toFixed(1);
document.getElementById('m_magY').value = (m_yw / (m_yMax - m_yMin)).toFixed(1);
document.getElementById('m_magZ').value = (m_zw / (m_zMax - m_zMin)).toFixed(1);
...
function changeType() {
    ...
    switch (type) {
        ...
        case "02":  // f(x,y) = (y - x^2)^2 + x^5
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = (y - x^2)^2 + x^5 $";
            break;
        case "03":  // f(x,y) = x^2y^2 / (x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^2y^2 / (x^2 + y^2) $";
            break;
        case "04":  // f(x,y) = (x - y) / (x + y)
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = (x - y) / (x + y) $";
            break;
        case "05":  // f(x,y) = |x|^y, f(0,y) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = |x|^y $";
            break;
        case "06":  // f(x,y) = xy*log(x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = xy \\cdot \\log(x^2 + y^2) $";
            break;
        case "07":  // f(x,y) = exp(-|x + y|*(x^2 + y^2)), f(0,0) = 0
            m_index = 7;
            if (resetFlg) {
                return;
            }
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\exp(-|x + y| \\cdot (x^2 + y^2)) $";
            break;
        case "08":  // f(x,y) = sqrt(|xy|)
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\sqrt{|xy|} $";
            break;
        case "09":  // f(x,y) = sqrt(x^2 + y^2)
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\sqrt{x^2 + y^2} $";
            break;
        case "10":  // f(x,y) = xy / sqrt(x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = xy / \\sqrt{x^2 + y^2} $";
            break;
        case "11":  // f(x,y) = xy * sin( 1 / sqrt(x^2 + y^2)), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = xy * \\sin( 1.0 / \\sqrt{x^2 + y^2}) $";
            break;
        case "12":  // f(x,y) = x^y * y^x
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^y \\cdot y^x $";
            break;
        case "13":  // f(x,y) = exp(-|x + y|/(x^2 + y^2)), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\exp(-|x + y|/(x^2 + y^2)) $";
            break;
        case "14":  // f(x,y) = log(x^2 + y^2), f(0,0) = -∞
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\log(x^2 + y^2) $";
            break;
        case "15":  // f(x,y) = x^3 - 3xy + y^3
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^3 - 3xy + y^3 $";
            break;
        case "16":  // f(x,y) = exp(-(x^2 + y^2) * sin(x + y))
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\exp(-(x^2 + y^2) \\cdot \\sin(x + y)) $";
            break;
        case "17":  // f(x,y) = x^4 + 2*x^2*y^2 - 6*x^2*y + y^2
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^4 + 2x^2y^2 - 6x^2y + y^2 $";
            break;
        ...
        case "19":  // f(x,y) = x^2 + xy + y^2 - 4x - 2y
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^2 + xy + y^2 - 4x - 2y $";
            break;
        case "20":  // f(x,y) = x*sin(y / x), f(0,y) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x \\cdot \\sin(y / x) $";
            break;
        case "21":  // f(x,y) = exp(-(x^3 + y^3) * sin(x + y))
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\exp(-(x^3 + y^3) \\cdot \\sin(x + y)) $";
            break;
        case "22":  // f(x,y) = x^4 + y^4 - 2(x^2 + y^2)
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^4 + y^4 - 2(x^2 + y^2) $";
            break;
        case "23":  // f(x,y) = sqrt((x^2 - y^2 - 1)^2 + 4 * x^2 * y^2)
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\sqrt{(x^2 - y^2 - 1)^2 + 4 \\cdot x^2 \\cdot y^2} $";
            break;
        case "24":  // f(x,y) = |sin(ω)|, ω = x + iy, x:-6.25to6.25 y:-10to10 //20230815 add
            m_index = 24;
            // 描画範囲
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = |\\sin(\\omega)|, \\omega = x + iy $";
            break;
        case "25":  // f(x,y) = |cos(ω)|, ω = x + iy, x:-6.25to6.25 y:-10to10 //20230815 add
            m_index = 25;
            // 描画範囲
            m_xMin = -6.25, m_xMax= 6.25;
            m_yMin = -3.0, m_yMax= 3.0;
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = |\\cos(\\omega)|, \\omega = x + iy $";
            break;
        case "26": //  f(x,y) = |Γ(ω)|, ω = x + iy //20230815 add
            m_index = 26;
            // 描画範囲
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = |\\Gamma(\\omega)|, \\omega = x + iy $";
            break;
        case "27":  // f(x,y) = (x^2 + y^2 + a^2)^2 - 4a^2x^2 - b^4, Cassini Ovals, a = 0.6, b=0.4 //20230815 add
            m_index = 27;
            // 描画範囲
            m_zMin =  -3.0, m_zMax =3.0;
            range_to_html();
            ...
            mb_used = 1;
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = (x^2 + y^2 + a^2)^2 - 4a^2x^2 - b^4 $";
            break;
        case "28":  // f(x,y) = x^3 + y^3 //20230815 add
            m_index = 28;
            // 描画範囲
            m_zMin =  -3.0, m_zMax =3.0;
            range_to_html();
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^3 + y^3 $";
            break;
        case "29":  // f(x,y) = x^a - 2x^b*y + y^a //20230815 add
            m_index = 29;
            // 描画範囲
            m_zMin =  -3.0, m_zMax =3.0;
            range_to_html();
            ...
            mb_used = 1;
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = x^a - 2x^b \\cdot y + y^a  $";
            break;
        case "30":  // f(x,y) = cos(y) - cos(x) //20230815 add
            m_index = 30;
            // 描画範囲
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('dx').innerText = "$ f(x, y) = \\cos(y) - \\cos(x) $";
            break;
        defaut:
            break;
    }
...
function FXY(x, y, m_index) {
    ...
    {
        case 1:
            //描画関数 01  f(x,y) = x^4 +xy - y^4 
            //FXY = math.sin(math.sqrt(x * x + y * y));
            //FXY = x * y;
            FXY = x*x*x*x + x * y - y*y*y*y;
            return FXY;
        case 2:
            //描画関数 02  f(x,y) = (y - x^2)^2 + x^5 
            FXY = (y - x*x) * (y - x*x) + x*x*x*x*x;
            return FXY;
        case 3:
            //描画関数 03  f(x,y) = x^2 * y^2 / (x^2 + y^2), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
        ...
        case 5:
            ...
            return FXY;
        case 6:
            //描画関数 06  f(x,y) =  xy*log(x^2 + y^2), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
            ...
            return FXY;
        case 7:
            //描画関数 07  f(x,y) = exp(-|x + y|*(x^2 + y^2)), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
            ...
            return FXY;
        case 8:
            //描画関数 08  f(x,y) = sqrt(|xy|), f(0,0) = 0
            FXY = math.sqrt(math.abs(x*y));
            return FXY;
        case 9:
            //描画関数 08  f(x,y) = sqrt(x^2 + y^2)
            FXY = math.sqrt(x*x + y*y);
            return FXY;
        case 10:
            //描画関数 10  f(x,y) = xy / sqrt(x^2 + y^2), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
            ...
            return FXY;
        case 11:
            //描画関数 11  f(x,y) = xy * sin( 1 / sqrt(x^2 + y^2)), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
            ...
            return FXY;
        case 12:
            //描画関数 12  f(x,y) = x^y * y^x
            FXY = math.pow(x, y) * math.pow(y, x);
            if (FXY > 1000.0) FXY = 1000.0
            if (FXY < -1000.0) FXY = -1000.0
            return FXY;
        case 13:
            //描画関数 10  f(x,y) = exp(-|x + y|/(x^2 + y^2)), f(0,0) = 0
            if (x == 0.0 && y == 0.0) {
                FXY = 0.0;
            }
            else {
        ...
        case 14:
            ...
            return FXY;
        case 15:
            //描画関数 15  f(x,y) = x^3 - 3xy + y^3
            FXY = x*x*x - 3.0 * x * y + y*y*y;
            return FXY;
        case 16:
            //描画関数 16  f(x,y) = exp(-(x^2 + y^2) * sin(x + y))
            FXY = math.exp(-(x*x + y*y) * math.sin(x + y));
            return FXY;
        case 17:
            //描画関数 16  f(x,y) = x^4 + 2*x^2*y^2 - 6*x^2*y + y^2
            FXY = x*x*x*x + 2.0 * x*x * y*y - 6.0 * x*x * y + y*y;
            return FXY;
        case 18:
            //描画関数 18  f(x,y) = x^3 + 3xy + y^3
            FXY = x*x*x + 3.0 * x * y + y*y*y;
            return FXY;
        case 19:
            //描画関数 19  f(x,y) = x^2 + xy + y^2 - 4x - 2y
            FXY = x*x + x*y + y*y - 4*x - 2*y;
            return FXY;
        case 20:
            //描画関数 20  f(x,y) = x*sin(y / x), f(0,y) = 0
            if (x == 0.0) {
                FXY = 0.0;
            }
            else {
        ...
        case 26:
            ...
            break;
        case 27:
            //描画関数 27  f(x,y) = (x^2 + y^2 + a^2)^2 - 4a^2x^2 - b^4, a = 0.6, b=0.4
            ...
            return FXY;
        case 28:
            //描画関数 28  f(x,y) = x^3 + y^3
            FXY = x*x*x + y*y*y;
            return FXY;
        case 29:
            //描画関数 29  f(x,y) = x^a - 2x^b*y + y^a, a = 5.0, b=2.0
            FXY = math.pow(x, ma) - 2*math.pow(x, mb) * y + math.pow(y, ma);
            return FXY;
        case 30:
            //描画関数 30  f(x,y) = cos(y) - cos(x)

...
/////////////////////////////////////////////////////////
// file name: PersFunc // comment: class CPersDlgのfxy_def()で定義した関数の計算実行部分 
// fxy <- x, yを代入して関数式からz値を求める
// class CPersDlgのfxy_def()と同期させる必要がある <-- ### 重要!! ###
// fxy(x, y, index);
/////////////////////////////////////////////////////////
...
let m_nx = 41, m_ny = 41;                    // 格子線の総本数
let m_mx = 41, m_my = 41;                    // 実際に描画する格子線の本数。m_nx，m_nyと同じでかまわないが，1/2或いは1/4に減らすときは

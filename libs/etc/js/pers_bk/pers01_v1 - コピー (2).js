...
function drawGraph() {
    ...
    let obj1x3Work, obj1y3Work;
    let obj1x3, obj1y3;
    let obj2x3, obj2y3, obj3x3, obj3y3;
//    for (let i = 0; i < divisions; i++) {
    for (let i = 0; i < 1; i++) {
        for (let j = 0; j < divisions; j++) {
//        for (let j = 0; j < 1; j++) {
...
/*
            ...
            ctx.stroke();
*/
            pixelX = scaleX * (obj1x3 + width0 / 2);
            pixelY = scaleY * (height0 / 2 - obj1y3);
            pixelX1 = scaleX * (obj2x3 + width0 / 2);
            pixelY1 = scaleY * (height0 / 2 - obj2y3);
...
//    const y0 = height0 / 2;
    return [
         canvas.width / 2 + x * scaleX,
         canvas.height / 2 - z * scaleY - y * scaleY
    ];
}

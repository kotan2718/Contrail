...
function dispFormula(flg) {
    if (flg == 0) {
        ...
        // 方程式入力ボックスを表示する
        document.getElementById('l_dxdt').style.display = "inline";
        document.getElementById('dxdt').style.display = "inline";
        document.getElementById('l_dydt').style.display = "inline";
        document.getElementById('dydt').style.display = "inline";
        document.getElementById('l_where').style.display = "inline";
        document.getElementById('dxdy_where').style.display = "inline";
    }
}
...
function g(dt, x, y) {
    return math.evaluate(formula_dy, { dt: dt, x: x, y: y });
}
...
function changeParagraphClasses(isDefaultEquation) {
    ...
    if (isDefaultEquation) {
        ...
        p2.classList.add('pb20');
        p1.classList.remove('pb0');
        p2.classList.remove('pb0');
    } else {
        p1.classList.remove('pb10', 'pb20');
        p2.classList.remove('pb10', 'pb20');

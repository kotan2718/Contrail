...
function startDraw() {
    ...
    if (m_index >= 90) {
        ...
        var fxyTex = "f(x, y) &=& " + node_fxy.toTex();
        var whereTex = "r = " + node_where.toTex();

        // 長い式を分割
        var maxLineLength = 35; // 最大文字数（調整可能）
        var splitfxyTex = splitLongTex(fxyTex, maxLineLength);
...
function changeType() {
    ...
    switch (type) {
        ...
        case "03":  // f(x,y) = x^2y^2 / (x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = x^2y^2 / (x^2 + y^2) $";
            break;
        ...
        case "05":  // f(x,y) = |x|^y, f(0,y) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = |x|^y $";
            break;
        case "06":  // f(x,y) = xy*log(x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = xy \\cdot \\log(x^2 + y^2) $";
            break;
        ...
        case "10":  // f(x,y) = xy / sqrt(x^2 + y^2), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = xy / \\sqrt{x^2 + y^2} $";
            break;
        case "11":  // f(x,y) = xy * sin( 1 / sqrt(x^2 + y^2)), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = xy \\cdot \\sin( 1 / \\sqrt{x^2 + y^2}) $";
            break;
        ...
        case "13":  // f(x,y) = exp(-|x + y|/(x^2 + y^2)), f(0,0) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = \\exp(-|x + y|/(x^2 + y^2)) $";
            break;
        case "14":  // f(x,y) = log(x^2 + y^2), f(0,0) = -∞
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = \\log(x^2 + y^2) $";
            break;
        ...
        case "20":  // f(x,y) = x*sin(y / x), f(0,y) = 0
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = x \\cdot \\sin(y / x) $";
            break;
        ...
        case "26": //  f(x,y) = |Γ(ω)|, ω = x + iy //20230815 add
            ...
            break;
        case "27":  // f(x,y) = x^3 + y^3 //20230815 add
            m_index = 27;
            if (resetFlg) {
                return;
            }
            ...
            // 係数デフォルト値
            // 式を表示する
            document.getElementById('fxy').innerText = "$ f(x, y) = x^3 + y^3 $";
            break;
        case "28":  // f(x,y) = cos(y) - cos(x) //20230815 add
            m_index = 28;
            if (resetFlg) {
                return;
            }
            ...
            break;
        case "29":  // f(x,y) = (x^2 + y^2 + a^2)^2 - 4a^2x^2 - b^4, Cassini Ovals, a = 0.6, b=0.4 //20230815 add
            m_index = 29;
            if (resetFlg) {
                return;
            }
            ...
            changeDivMargin(true);
            break;
        case "30":  // f(x,y) = x^a - 2x^b*y + y^a //20230815 add
            m_index = 30;
            if (resetFlg) {
                return;
            }
...
function FXY(x, y, m_index) {
    ...
    switch (m_index)
    {
        ...
        case 26:
            ...
            break;
        case 27:
            //描画関数 27  f(x,y) = x^3 + y^3
            FXY = x*x*x + y*y*y;
            return FXY;
        case 28:
            //描画関数 28  f(x,y) = cos(y) - cos(x)
            FXY = math.cos(y) - math.cos(x);
            return FXY;
        case 29:
            //描画関数 29  f(x,y) = (x^2 + y^2 + a^2)^2 - 4a^2x^2 - b^4, a = 0.6, b=0.4
            ...
            return FXY;
        case 30:
            //描画関数 30  f(x,y) = x^a - 2x^b*y + y^a, a = 5.0, b=2.0
...
function f(x, y) {
    ...
    return math.evaluate(formula_fxy, { x: x, y: y, r: r });
}
